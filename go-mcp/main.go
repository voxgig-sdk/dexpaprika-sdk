// Command Dexpaprika-mcp is an MCP server exposing the Dexpaprika
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Dexpaprika_list  — list records of an entity
//	Dexpaprika_load  — load a single record of an entity
//
