...
describe('TickerEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set DEXPAPRIKA_TEST_TICKER_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['DEXPAPRIKA_TEST_TICKER_ENTID']
  ...
  idmap = env['DEXPAPRIKA_TEST_TICKER_ENTID']
