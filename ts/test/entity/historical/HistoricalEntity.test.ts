...
describe('HistoricalEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set DEXPAPRIKA_TEST_HISTORICAL_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['DEXPAPRIKA_TEST_HISTORICAL_ENTID']
  ...
  idmap = env['DEXPAPRIKA_TEST_HISTORICAL_ENTID']
