...
class PoolEntity
  ...
  #
  # @param reqmatch [PoolListMatch, Hash, nil] match filter (any subset of
  #   Pool fields); defaults to nil, treated as an empty match that lists all.
