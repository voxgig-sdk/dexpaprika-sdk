...
class ExchangeEntity
  ...
  def make
    opts = @_entopts.dup
    ExchangeEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ExchangeListMatch, Hash, nil] match filter (any subset of
  #   Exchange fields); defaults to nil, treated as an empty match that lists all.
