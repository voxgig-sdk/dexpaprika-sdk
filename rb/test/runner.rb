...
module DexpaprikaTestRunner
  ...
  def self.env_override(m)
    live = getenv("DEXPAPRIKA_TEST_LIVE")
    override = getenv("DEXPAPRIKA_TEST_OVERRIDE")
    ...
    explain = getenv("DEXPAPRIKA_TEST_EXPLAIN")
    m["DEXPAPRIKA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DexpaprikaTestRunner
Helpers = DexpaprikaHelpers
Vs = VoxgigStruct
