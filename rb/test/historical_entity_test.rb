...
class HistoricalEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DEXPAPRIKA_TEST_HISTORICAL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def historical_basic_setup(extra)
  ...
  entid_env_raw = ENV["DEXPAPRIKA_TEST_HISTORICAL_ENTID"]
