...
// Dexpaprika SDK utility: graphql
//
...
class DexpaprikaGraphql
{
    ...
    // equivalent.
    public static function body(DexpaprikaContext $ctx): mixed
    {
    ...
    public static function errors(DexpaprikaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
