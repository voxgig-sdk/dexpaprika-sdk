...
// Dexpaprika SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DexpaprikaMakeRequest
{
    public static function call(DexpaprikaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DexpaprikaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DexpaprikaResponse($fetched);
        } else {
