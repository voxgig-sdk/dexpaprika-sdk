...
class DexpaprikaNetsimFeature extends DexpaprikaBaseFeature
{
    ...
    private function _simulate(DexpaprikaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DexpaprikaContext $ctx, array $applied): void
    {
        $client = $this->client;
