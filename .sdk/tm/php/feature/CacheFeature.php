...
class DexpaprikaCacheFeature extends DexpaprikaBaseFeature
{
    ...
    private function _through(DexpaprikaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
