...
// Dexpaprika SDK streaming feature
...
class DexpaprikaStreamingFeature extends DexpaprikaBaseFeature
{
    ...
    private function _iterate(DexpaprikaResult $result): \Generator
    {
    ...
    private function _streamable(DexpaprikaContext $ctx): bool
    {
