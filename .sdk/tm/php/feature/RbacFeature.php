...
class DexpaprikaRbacFeature extends DexpaprikaBaseFeature
{
    ...
    private function _required(DexpaprikaContext $ctx): ?string
    {
    ...
    private function _reject(DexpaprikaContext $ctx, string $required): void
    {
    ...
    private function _track(DexpaprikaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
