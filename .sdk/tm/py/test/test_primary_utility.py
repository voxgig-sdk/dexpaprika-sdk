# Dexpaprika SDK primary utility test
...
from projectname_sdk import DexpaprikaSDK
from projectname_sdk.core.spec import DexpaprikaSpec
from projectname_sdk.core.result import DexpaprikaResult
from projectname_sdk.core.response import DexpaprikaResponse
from projectname_sdk.core.operation import DexpaprikaOperation
from projectname_sdk.core.error import DexpaprikaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DexpaprikaBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return DexpaprikaError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DexpaprikaSDK.test(None, None)
        ...
        class TestInitFeature(DexpaprikaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DexpaprikaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DexpaprikaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DexpaprikaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DexpaprikaSDK.test(None, setup_opts)
