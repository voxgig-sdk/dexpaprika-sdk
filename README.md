...
DexPaprika provides access to comprehensive decentralized exchange (DEX) data, including real-time token prices, liquidity pools, and trading volumes.

Learn more about DexPaprika API at [dexpaprika.com](https://dexpaprika.com).
...
This SDK exposes the API as a small set of **semantic entities** — Exchange, Historical, Pool, Ticker and Token — that you
...
const items = await client.Exchange().list()
```
...
| Go CLI | `github.com/voxgig-sdk/dexpaprika-sdk/go-cli` | `go install github.com/voxgig-sdk/dexpaprika-sdk/go-cli/cmd/dexpaprika@latest` |
| Go MCP server | `github.com/voxgig-sdk/dexpaprika-sdk/go-mcp` | `go get github.com/voxgig-sdk/dexpaprika-sdk/go-mcp@latest` |
