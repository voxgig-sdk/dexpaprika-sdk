...
func registerSDKWords(r *eng.Registry, client *sdk.DexpaprikaSDK) {
...
func runOp(client *sdk.DexpaprikaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
