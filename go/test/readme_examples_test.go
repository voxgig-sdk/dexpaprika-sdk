...
const testSeed = `map[string]any{"entity": map[string]any{"exchange": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "historical": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pool": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticker": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "token": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
