...
// instead of `sdk.NewDexpaprikaSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DexpaprikaSDK  { return NewDexpaprikaSDK(nil) }
func Test() *DexpaprikaSDK { return TestSDK(nil, nil) }
