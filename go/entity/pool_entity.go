...
func NewPoolEntity(client *core.DexpaprikaSDK, entopts map[string]any) *PoolEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PoolEntity) GetName() string { return e.name }
...
func (e *PoolEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PoolEntity) Deleted() bool {
	return e.deleted
}


func (e *PoolEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPoolEntity(e.client, opts)
}

func (e *PoolEntity) Data(args ...any) any {
...
func (e *PoolEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pool; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PoolEntity) DataTyped(data ...Pool) Pool {
	if len(data) > 0 {
		return typedFrom[Pool](e.Data(asMap(data[0])))
	}
	return typedFrom[Pool](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pool (all fields
// optional at the wire level).
func (e *PoolEntity) MatchTyped(match ...Pool) Pool {
	if len(match) > 0 {
		return typedFrom[Pool](e.Match(asMap(match[0])))
	}
	return typedFrom[Pool](e.Match())
}
...
func (e *PoolEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PoolEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PoolEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PoolListMatch and returns []Pool. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PoolEntity) ListTyped(reqmatch PoolListMatch, ctrl map[string]any) ([]Pool, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Pool](res), nil
}



func (e *PoolEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PoolEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PoolEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PoolEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
