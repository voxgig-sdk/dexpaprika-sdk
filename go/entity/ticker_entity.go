...
func NewTickerEntity(client *core.DexpaprikaSDK, entopts map[string]any) *TickerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TickerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
