...
func NewExchangeEntity(client *core.DexpaprikaSDK, entopts map[string]any) *ExchangeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExchangeEntity) GetName() string { return e.name }
...
func (e *ExchangeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ExchangeEntity) Deleted() bool {
	return e.deleted
}


func (e *ExchangeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewExchangeEntity(e.client, opts)
}

func (e *ExchangeEntity) Data(args ...any) any {
...
func (e *ExchangeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Exchange; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ExchangeEntity) DataTyped(data ...Exchange) Exchange {
	if len(data) > 0 {
		return typedFrom[Exchange](e.Data(asMap(data[0])))
	}
	return typedFrom[Exchange](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Exchange (all fields
// optional at the wire level).
func (e *ExchangeEntity) MatchTyped(match ...Exchange) Exchange {
	if len(match) > 0 {
		return typedFrom[Exchange](e.Match(asMap(match[0])))
	}
	return typedFrom[Exchange](e.Match())
}
...
func (e *ExchangeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExchangeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ExchangeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ExchangeListMatch and returns []Exchange. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ExchangeEntity) ListTyped(reqmatch ExchangeListMatch, ctrl map[string]any) ([]Exchange, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Exchange](res), nil
}



func (e *ExchangeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ExchangeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ExchangeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ExchangeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
