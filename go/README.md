...
The Golang SDK for the Dexpaprika API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/dexpaprika-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/dexpaprika-sdk=../path/to/github.com/voxgig-sdk/dexpaprika-sdk
```
...
```
github.com/voxgig-sdk/dexpaprika-sdk/
...
The root package (`github.com/voxgig-sdk/dexpaprika-sdk`) re-exports everything needed
