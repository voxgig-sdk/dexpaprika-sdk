# Dexpaprika SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DexpaprikaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DexpaprikaSDK(...) and DexpaprikaSDK.test(...) become
#      DexpaprikaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dexpaprika_sdk"
_SDK_CLASS = "DexpaprikaSDK"
