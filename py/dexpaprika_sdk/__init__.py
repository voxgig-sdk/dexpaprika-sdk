...
from dexpaprika_sdk.utility import register

# Load features
from dexpaprika_sdk.feature.base_feature import DexpaprikaBaseFeature
from dexpaprika_sdk.features import _has_feature, _make_feature
...
class DexpaprikaSDK:
    ...
    def get_utility(self):
        return DexpaprikaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DexpaprikaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Exchange(self, data=None) -> "ExchangeEntity":
        ...
        from dexpaprika_sdk.entity.exchange_entity import ExchangeEntity
