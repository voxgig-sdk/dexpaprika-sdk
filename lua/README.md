...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/dexpaprika-sdk/releases)),
...
Create an instance: `local exchange = client:Exchange(nil)`
...
| `trades_24h` | `number` | Number of trades in last 24 hours |
...
Create an instance: `local pool = client:Pool(nil)`
...
```lua
local pools, err = client:Pool():list()
```
...
```
lua/
├── dexpaprika_sdk.lua    -- Main SDK module
...
The main module (`dexpaprika_sdk`) exports the SDK constructor
