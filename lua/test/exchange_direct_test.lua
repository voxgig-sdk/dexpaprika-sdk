...
describe("ExchangeDirect", function()
  it("should direct-list-exchange", function()
    local setup = exchange_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-exchange", setup.live and "live" or "unit")
