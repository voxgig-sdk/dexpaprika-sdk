...
local SDK_MODULE = "dexpaprika_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["exchange"] = { ["test01"] = { id = "test01" } }, ["historical"] = { ["test01"] = { id = "test01" } }, ["pool"] = { ["test01"] = { id = "test01" } }, ["ticker"] = { ["test01"] = { id = "test01" } }, ["token"] = { ["test01"] = { id = "test01" } } } }'
