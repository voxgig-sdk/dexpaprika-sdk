...
describe("TokenEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DEXPAPRIKA_TEST_TOKEN_ENTID JSON to run live")
      return
    end
...
function token_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DEXPAPRIKA_TEST_TOKEN_ENTID")
