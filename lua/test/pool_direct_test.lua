...
describe("PoolDirect", function()
  it("should direct-list-pool", function()
    local setup = pool_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pool", setup.live and "live" or "unit")
...
function pool_direct_setup(mockres)
