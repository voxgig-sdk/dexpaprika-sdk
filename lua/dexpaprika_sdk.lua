...
local DexpaprikaSDK = {}
DexpaprikaSDK.__index = DexpaprikaSDK
...
DexpaprikaSDK._make_feature = _make_feature


function DexpaprikaSDK.new(options)
  local self = setmetatable({}, DexpaprikaSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DexpaprikaSDK:options_map()
...
function DexpaprikaSDK:get_utility()
  return Utility.copy(self._utility)
end


function DexpaprikaSDK:get_root_ctx()
  return self._rootctx
end


function DexpaprikaSDK:prepare(fetchargs)
...
function DexpaprikaSDK:direct(fetchargs)
...
-- by passing it.
function DexpaprikaSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DexpaprikaSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "DexpaprikaSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function DexpaprikaSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DexpaprikaSDK.new(sdkopts)
  sdk.mode = "test"
