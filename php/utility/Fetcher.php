...
// Dexpaprika SDK utility: fetcher
...
class DexpaprikaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DexpaprikaSDK/1.0)';
    ...
    public static function call(DexpaprikaContext $ctx, string $fullurl, array $fetchdef): array
    {
