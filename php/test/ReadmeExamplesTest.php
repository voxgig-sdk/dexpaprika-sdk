...
// Dexpaprika SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DexpaprikaSDK::test)
...
{
    private const SDK_CLASS = 'DexpaprikaSDK';
    ...
    private const SDK_BASE = 'dexpaprika_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dexpaprika_sdk.php';
