...
class TokenEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Token(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Token(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DEXPAPRIKA_TEST_TOKEN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function token_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DEXPAPRIKA_TEST_TOKEN_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["DEXPAPRIKA_TEST_TOKEN_ENTID"]);
