...
class PoolDirectTest extends TestCase
{
    public function test_direct_list_pool(): void
    {
        $setup = pool_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pool", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
