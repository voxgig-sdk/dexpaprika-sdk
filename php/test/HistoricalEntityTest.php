...
class HistoricalEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DEXPAPRIKA_TEST_HISTORICAL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function historical_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DEXPAPRIKA_TEST_HISTORICAL_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["DEXPAPRIKA_TEST_HISTORICAL_ENTID"]);
