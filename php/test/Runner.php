...
class DexpaprikaTestRunner
{
    ...
    {
        $live = self::getenv('DEXPAPRIKA_TEST_LIVE');
        $override = self::getenv('DEXPAPRIKA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DEXPAPRIKA_TEST_EXPLAIN');
...
class_alias('DexpaprikaTestRunner', 'Runner');
class_alias('DexpaprikaHelpers', 'Helpers');
