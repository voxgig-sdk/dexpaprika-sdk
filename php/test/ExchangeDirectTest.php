...
class ExchangeDirectTest extends TestCase
{
    public function test_direct_list_exchange(): void
    {
        $setup = exchange_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-exchange", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function exchange_direct_setup($mockres)
{
