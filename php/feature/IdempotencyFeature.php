...
// Dexpaprika SDK idempotency feature
...
class DexpaprikaIdempotencyFeature extends DexpaprikaBaseFeature
{
    ...
    private function _mutating(DexpaprikaContext $ctx): bool
    {
