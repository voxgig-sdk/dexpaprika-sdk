...
class DexpaprikaProxyFeature extends DexpaprikaBaseFeature
{
    ...
    public function init(DexpaprikaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DexpaprikaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
