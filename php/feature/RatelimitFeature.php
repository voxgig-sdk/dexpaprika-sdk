...
// Dexpaprika SDK ratelimit feature
...
class DexpaprikaRatelimitFeature extends DexpaprikaBaseFeature
{
    ...
    private function _acquire(DexpaprikaContext $ctx): void
    {
    ...
    private function _track(DexpaprikaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
