...
// Dexpaprika SDK telemetry feature
...
class DexpaprikaTelemetryFeature extends DexpaprikaBaseFeature
{
    ...
    private function _close(DexpaprikaContext $ctx, bool $ok): void
    {
