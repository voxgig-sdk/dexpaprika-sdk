...
// Dexpaprika SDK timeout feature
...
class DexpaprikaTimeoutFeature extends DexpaprikaBaseFeature
{
    ...
    private function _with_timeout(DexpaprikaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DexpaprikaContext $_ctx, float $ms): void
    {
        $client = $this->client;
