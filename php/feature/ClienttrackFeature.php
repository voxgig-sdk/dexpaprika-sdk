...
// Dexpaprika SDK clienttrack feature
...
class DexpaprikaClienttrackFeature extends DexpaprikaBaseFeature
{
    ...
    public function PostConstruct(DexpaprikaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Dexpaprika-SDK';
