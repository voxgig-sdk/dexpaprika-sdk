...
// Dexpaprika SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DexpaprikaTestFeature extends DexpaprikaBaseFeature
{
    ...
    public function init(DexpaprikaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DexpaprikaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DexpaprikaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DexpaprikaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DexpaprikaContext $ctx, $op, $args): array
    {
