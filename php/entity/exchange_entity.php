...
// Dexpaprika SDK Exchange entity
...
class ExchangeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ExchangeEntity($this->_client, $opts);
    }

    /**
     * @param Exchange|array $args Exchange data (assoc-array) to store.
     */
    ...
    /**
     * @return Exchange|array The current Exchange data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Exchange fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Exchange fields).
     */
     ...
     *
     * @param ExchangeListMatch|array|null $reqmatch Match filter (any subset
     *   of Exchange fields) as an assoc-array; ExchangeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Exchange[]|array A list of Exchange items as assoc-arrays at
